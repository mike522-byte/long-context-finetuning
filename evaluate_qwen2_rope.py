...
for sf in SCALING_FACTORS:
    ...
    model = Qwen2ForCausalLM.from_pretrained(MODEL_NAME, torch_dtype=torch.float16).to(DEVICE)
...
df.to_csv("qwen_rope_results.csv", index=False)
print("\nResults saved to qwen_rope_results.csv")
